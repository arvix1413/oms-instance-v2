    ...
    <div className="max-w-2xl">
      ...
      <div className="oms-card p-6 space-y-5">
        ...
        {[
          ...
          { key: 'address', label: '地址', placeholder: '152 Hà Huy Tập, P. Tân Hưng, TP. HCM' },
          { key: 'phone', label: '電話 / 聯絡方式', placeholder: '0909883372 Danny Lin / 0909042239 Mỹ Linh' },
      ...
      {/* Preview */}
      <div className="oms-card p-5 mt-4">
