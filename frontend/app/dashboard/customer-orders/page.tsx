          ...
          <div className="h-full overflow-auto rounded-lg border border-slate-200 bg-white">
            <table className="w-full text-xs oms-table">
              <thead><tr className="bg-slate-50 border-b border-slate-200">
                ...
                <th className="sticky top-0 z-10 bg-slate-50 px-3 py-2 text-left text-[10px] font-semibold text-slate-500 uppercase shadow-sm">品名（BOM）</th>
                <th className="sticky top-0 z-10 bg-slate-50 px-3 py-2 text-left text-[10px] font-semibold text-slate-500 uppercase shadow-sm">規格</th>
                <th className="sticky top-0 z-10 bg-slate-50 px-3 py-2 text-left text-[10px] font-semibold text-slate-500 uppercase shadow-sm">單位</th>
                <th className="sticky top-0 z-10 bg-slate-50 px-3 py-2 text-left text-[10px] font-semibold text-slate-500 uppercase shadow-sm">數量</th>
                <th className="sticky top-0 z-10 bg-slate-50 px-3 py-2 text-left text-[10px] font-semibold text-slate-500 uppercase shadow-sm">單價</th>
                <th className="sticky top-0 z-10 bg-slate-50 px-3 py-2 text-right text-[10px] font-semibold text-slate-500 uppercase shadow-sm">小計</th>
