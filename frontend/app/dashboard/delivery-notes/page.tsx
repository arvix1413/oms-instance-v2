                ...
                <tbody className="divide-y divide-white/[0.04]">
                  {paged.map(dn=>(
                    <tr key={dn.id} className="hover:bg-slate-50">
                      ...
                      <td className="px-3 py-2 font-medium whitespace-nowrap max-w-[200px] truncate">{dn.customer_name}</td>
                      <td className="px-3 py-2 text-slate-400 whitespace-nowrap">{dn.delivery_date}</td>
                      <td className="px-3 py-2 text-slate-400 whitespace-nowrap max-w-[150px] truncate">{dn.remark}</td>
