...
export function generateDeliveryNoteHTML(data: any, signatureUrl?: string, company?: CompanySettings): string {
  ...
  parts.push('table.items .col-order{width:118px;white-space:nowrap !important;overflow-wrap:normal !important;word-break:keep-all !important}')
  parts.push('table.items .col-material{width:118px;white-space:nowrap !important;overflow-wrap:normal !important;word-break:keep-all !important}')
  parts.push('table.items .col-spec{width:118px;white-space:nowrap !important;overflow-wrap:normal !important;word-break:keep-all !important}')
  parts.push('table.items .col-unit{width:45px}')
  parts.push('table.items .col-qty{width:60px}')
  parts.push('table.items .col-remark{width:82px}')
